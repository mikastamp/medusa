...
medusaIntegrationTestRunner({
  ...
  testSuite: ({ dbConnection, getContainer, api }) => {
    describe("Store Carts API", () => {
      ...
      // describe.skip("POST /store/carts", () => {
      ...
      describe.only("POST /store/carts/:id/line-items", () => {
        ...
        describe.skip("with custom shipping options prices", () => {
          beforeEach(async () => {
            cart = (
              await api.post(
                `/store/carts`,
        ...
        describe.skip("with sale price lists", () => {
          beforeEach(async () => {
            await api.post(
              `/admin/price-lists`,
              {
      ...
      // describe.skip("POST /store/carts/:id/complete", () => {
      ...
      // describe.skip("POST /store/carts/:id", () => {
      //   let otherRegion
      ...
      // describe.skip("POST /store/carts/:id/customer", () => {
      //   beforeEach(async () => {
      //     cart = (
      //       await api.post(
      //         `/store/carts`,
      ...
      // describe.skip("POST /store/carts/:id/shipping-methods", () => {
      //   let shippingOption
