...
By following this guide, you'll create a Medusa plugin that migrates data from a Magento server to a Medusa application with minimal time. You can re-use this plugin across multiple Medusa applications, allowing you to adopt Medusa across your projects.
...
Medusa supports integrating third-party services, such as [S3](../../../architectural-modules/file/s3/page.mdx), in a File Module Provider. Find other module providers and how to create a custom provider in [this documentation](../../../architectural-modules/file/page.mdx).
