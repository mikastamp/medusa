...
const PLUGIN_ENTRY_VIRTUAL_MODULE = "virtual:medusa-admin-plugin-entry"
const RESOLVED_PLUGIN_ENTRY_VIRTUAL_MODULE = `\0${PLUGIN_ENTRY_VIRTUAL_MODULE}`
...
const RESOLVED_VIRTUAL_MODULES = [
  ...
  RESOLVED_PLUGIN_ENTRY_VIRTUAL_MODULE,
] as const
...
export type VirtualModule =
  ...
  | typeof PLUGIN_ENTRY_VIRTUAL_MODULE
...
const resolvedVirtualModuleIds = {
  ...
  pluginEntry: RESOLVED_PLUGIN_ENTRY_VIRTUAL_MODULE,
} as const
...
const virtualModuleIds = {
  ...
  pluginEntry: PLUGIN_ENTRY_VIRTUAL_MODULE,
} as const
