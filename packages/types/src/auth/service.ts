...
export interface IAuthModuleService extends IModuleService {
   ...
   *
   * Refer to [this guide](https://docs.medusajs.com/v1/experimental/auth/auth-flows) to learn more about the authentication flows.
   *
   ...
   *
   * Learn more about this authentication flow in [this guide](https://docs.medusajs.com/v1/experimental/auth/auth-flows#authentication-with-third-party-service).
   *
